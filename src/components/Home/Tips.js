    ...
    <div className="grid grid-rows-tips bg:greyish-white">
      ...
      <ul className="p-4 row-start-2 space-y-2 list-none text-center justify-self-center">
        <li>
          ...
          block your account from accessing your funds.
        </li>
        <li>
          ...
          you don't want to spend the funds from that wallet you can then send
          the money to a non KYC Exchange to which is usually a general wallet
          address or use a Third Party before sending money back to you main
          wallet.
        </li>
        <li>
